...
from server_fastapi.services.trading.futures_trading_service import FuturesTradingService
from server_fastapi.repositories.futures_position_repository import FuturesPositionRepository
...
@pytest.mark.asyncio
async def test_futures_position_liquidation_price(test_db: AsyncSession, test_user: User):
