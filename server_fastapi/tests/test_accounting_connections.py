...
from server_fastapi.services.tax.accounting_connection_service import (
...
class TestAccountingConnection:
    ...
    async def test_connection_storage(self, db_session: AsyncSession, test_user: User):
    ...
    async def test_token_refresh(self, db_session: AsyncSession, test_user: User):
        """Test token refresh"""
        service = AccountingConnectionService(db_session)
    ...
    async def test_sync_logging(self, db_session: AsyncSession, test_user: User):
