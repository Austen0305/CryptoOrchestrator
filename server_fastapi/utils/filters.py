...
def get_bot_filter_query(filter_type: BotFilter) -> dict[str, Any]:
    ...
    filters = {
        BotFilter.ALL: {},
        BotFilter.ACTIVE: {"is_active": True, "status": "running"},
        BotFilter.PAUSED: {"is_active": False},
        ...
        BotFilter.RECENTLY_CREATED: {"created_at__gte": now - timedelta(days=7)},
    }
...
def get_trade_filter_query(filter_type: TradeFilter) -> dict[str, Any]:
    ...
    filters = {
        TradeFilter.ALL: {},
        TradeFilter.TODAY: {"executed_at__gte": today_start},
        TradeFilter.THIS_WEEK: {"executed_at__gte": week_start},
        TradeFilter.THIS_MONTH: {"executed_at__gte": month_start},
        TradeFilter.WINNING: {"profit__gt": 0},
        TradeFilter.LOSING: {"profit__lt": 0},
