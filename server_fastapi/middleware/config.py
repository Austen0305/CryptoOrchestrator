...
class MiddlewareManager:
    ...
    def _load_config(self):
        ...
        if enable_heavy and not is_testing:
            self.middlewares.extend([
                ...
                MiddlewareConfig(
                    name="ip_whitelist",
                    enabled=os.getenv("ENABLE_IP_WHITELIST", "false").lower() == "true",
                    priority=MiddlewarePriority.CRITICAL,
                ...
                MiddlewareConfig(
                    ...
                    enabled=os.getenv("ENABLE_CSRF_PROTECTION", "false").lower() == "true",
                    priority=MiddlewarePriority.CRITICAL,
    ...
    def get_enabled_middlewares(self) -> List[MiddlewareConfig]:
        ...
        enabled = [
            ...
            if m.enabled and self._check_condition(m)
        ]
        # Sort by priority
