...
class APIAnalyticsMiddleware(BaseHTTPMiddleware):
    ...
    def _record_hourly_stats(self, endpoint: str, duration: float, status_code: int):
        ...
        total_duration = hour_stats["avg_duration"] * (hour_stats["requests"] - 1) + duration
    ...
    def get_endpoint_stats(self, endpoint: Optional[str] = None) -> Dict[str, Any]:
        ...
        if endpoint:
            ...
            return {
                **stats,
                "avg_time_ms": (stats.get("total_time", 0) / count * 1000) if count > 0 else 0,
                "error_rate": (stats.get("errors", 0) / count * 100) if count > 0 else 0,
            }
    ...
    def get_analytics_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "error_rate": (
                ...
                if self.analytics["total_requests"] > 0 else 0
            ),
