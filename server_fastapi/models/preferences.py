...
class UserPreferencesModel(BaseModel):
    ...
    theme: Mapped[Optional[str]] = mapped_column(String(20), default="light", nullable=True)
    language: Mapped[Optional[str]] = mapped_column(String(10), default="en", nullable=True)
    notifications_enabled: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    data_json: Mapped[Optional[str]] = mapped_column(Text, nullable=True)  # arbitrary serialized preferences
