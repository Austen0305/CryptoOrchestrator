...
class Strategy(Base):
    ...
    strategy_type = Column(String, nullable=False)  # rsi, macd, breakout, lstm, transformer, custom
    category = Column(String, nullable=False)  # technical, ml, hybrid
    version = Column(String, default="1.0.0")
    parent_strategy_id = Column(String, ForeignKey("strategies.id"), nullable=True)  # For versioning
