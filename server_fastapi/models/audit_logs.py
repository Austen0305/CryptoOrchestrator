...
class AuditLog(Base, TimestampMixin):
    ...
    event_category = Column(String(50), nullable=False, index=True)  # user_action, system_event, data_change, security, trading
    ...
    resource_type = Column(String(100), nullable=True, index=True)  # trade, user, bot, etc.
    ...
    # Compliance metadata
    retention_until = Column(DateTime, nullable=True, index=True)  # When this log can be archived
    ...
    __table_args__ = (
        Index("idx_audit_logs_event_type_category", "event_type", "event_category", "created_at"),
