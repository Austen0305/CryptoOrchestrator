...
class Subscription(BaseModel):
    ...
    plan: Mapped[str] = mapped_column(String(50), nullable=False, default="free")  # free, basic, pro
    status: Mapped[str] = mapped_column(String(50), nullable=False, default="inactive")  # active, canceled, past_due, trialing, incomplete
