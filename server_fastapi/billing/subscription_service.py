...
class SubscriptionService:
    ...
    async def update_subscription_from_stripe(
        ...
        try:
            ...
            logger.info(f"Updated subscription for user {user_id}: {subscription.plan} - {subscription.status}")
            return subscription
    ...
    async def get_subscription_limits(
        ...
        config = StripeService.get_plan_config(plan) or StripeService.get_plan_config(SubscriptionPlan.FREE.value)
