...
async def get_notifications(
    ...
    try:
        ...
        priority_enums = [NotificationPriority(p) for p in priority] if priority else None
...
async def mark_all_notifications_read(
    ...
    try:
        category_enum = NotificationCategory(category) if category else None
        count = await notification_service.mark_all_as_read(current_user['id'], category_enum)
