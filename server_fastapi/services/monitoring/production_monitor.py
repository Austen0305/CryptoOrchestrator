...
class ProductionMonitor:
    ...
    def __init__(self):
        ...
        self.exchange_errors: Dict[str, List[datetime]] = {}  # Track errors per exchange
        ...
        try:
            ...
            if exchange.is_connected():
                ...
                try:
                    ...
                    logger.warning(f"Exchange {exchange_name} connected but API call failed: {e}")
    ...
    async def check_all_exchanges(self) -> Dict[str, ExchangeStatus]:
        ...
        tasks = [self.check_exchange_health(exchange) for exchange in supported_exchanges]
    ...
    async def get_system_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            healthy_count = sum(1 for s in exchange_statuses.values() if s == ExchangeStatus.CONNECTED)
    ...
    async def get_exchange_status(self, exchange_name: str) -> Dict[str, Any]:
        ...
        recent_errors = sum(
            1 for error_time in self.exchange_errors.get(exchange_name, [])
        ...
        return {
            ...
            "total_errors_24h": len([
                e for e in self.exchange_errors.get(exchange_name, [])
    ...
    async def get_alerts(self) -> List[Dict[str, Any]]:
        ...
        if self.trading_metrics["failed_trades_24h"] > 0:
            failure_rate = (
                ...
                if self.trading_metrics["total_trades_24h"] > 0 else 0
            )
