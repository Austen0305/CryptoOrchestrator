...
class ColdStorageService:
    ...
    async def check_cold_storage_eligibility(
        ...
        return {
            ...
            "reason": (
                "High-value transfer eligible for cold storage" if should_use_cold
    ...
    async def initiate_cold_storage_transfer(
        ...
        try:
            ...
            transaction = WalletTransaction(
                ...
                net_amount=amount,
                description=description or f"Cold storage transfer: {amount} {currency}",
                metadata={
                    "cold_storage": True,
    ...
    async def complete_cold_storage_transfer(self, transaction_id: int) -> bool:
        ...
        try:
            ...
            if wallet:
                ...
                logger.info(f"Cold storage transfer completed: transaction {transaction_id}")
                return True
    ...
    async def get_cold_storage_balance(
        ...
        try:
            ...
            return {
                ...
                "total_value_usd": await self._estimate_total_usd_value(total_by_currency)
            }
