...
class ShardingService:
    ...
    def __init__(self):
        ...
        self.enabled = False
        self.sharding_strategy = "consistent_hash"  # "consistent_hash", "range", "directory"
    ...
    def get_shard_for_key(self, shard_key: str) -> Optional[Shard]:
        """
    ...
    def get_shard_for_user(self, user_id: int) -> Optional[Shard]:
        """Get shard for a user ID"""
        return self.get_shard_for_key(f"user_{user_id}")
    
    def get_shard_for_wallet(self, wallet_id: str) -> Optional[Shard]:
