...
class MetricsService:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "histograms": {
                k: v.get_summary() for k, v in self.histograms.items()
            },
            "timers": {
                k: self._get_timer_stats(v) for k, v in self.timers.items()
            },
        }
    
    def get_metric(self, name: str, metric_type: str = "counter") -> Optional[Any]:
