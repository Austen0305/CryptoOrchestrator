...
class AlertService:
    ...
    def evaluate_metric(self, metric_name: str, value: float, tags: Optional[Dict[str, str]] = None):
        ...
        for rule_name, rule in self.rules.items():
            ...
            if last_alert_key in self.last_alert_time:
                time_since_last = datetime.utcnow() - self.last_alert_time[last_alert_key]
