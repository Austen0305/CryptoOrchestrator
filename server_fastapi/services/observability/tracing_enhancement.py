...
try:
    ...
    logger.warning(
        "OpenTelemetry not available. Install with: pip install opentelemetry-api opentelemetry-sdk opentelemetry-instrumentation-fastapi opentelemetry-instrumentation-requests opentelemetry-instrumentation-sqlalchemy"
    )
...
class TracingEnhancementService:
    ...
    def end_span(self, span, status: str = "ok", error: Exception | None = None):
        """
        End a span
