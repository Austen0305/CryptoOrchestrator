...
class EmailService:
    ...
    def _initialize_provider(self):
        ...
        try:
            ...
            # SMTP fallback
            if self.provider == "smtp" or (not self.sendgrid_client and not self.ses_client):
                self.smtp_config = {
    ...
    async def send_email(
        ...
        try:
            ...
            if self.provider == "sendgrid" and self.sendgrid_client:
                return await self._send_via_sendgrid(to, subject, html_content, text_content, from_email, from_name)
            elif self.provider == "ses" and self.ses_client:
                return await self._send_via_ses(to, subject, html_content, text_content, from_email, from_name)
            else:
                return await self._send_via_smtp(to, subject, html_content, text_content, from_email, from_name)
