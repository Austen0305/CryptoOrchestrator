...
class AccountingExportService:
    ...
    def export_to_quickbooks(
        ...
        for tx in transactions:
            ...
            account_code = self.account_codes[AccountingSystem.QUICKBOOKS].get(account, "12000")
    ...
    def convert_tax_events_to_transactions(
        ...
        for event in tax_events:
            sale_date = datetime.fromisoformat(event.get("sale_date", datetime.utcnow().isoformat()))
