...
class TaxSoftwareIntegrationService:
    ...
    def __init__(self):
        ...
        self.credentials: dict[
            int, dict[TaxSoftware, TaxSoftwareCredentials]
        ] = {}  # user_id -> software -> creds
        self.enabled = True
    ...
    def export_to_turbotax(
        ...
        logger.info(
            f"Exported tax data to TurboTax for user {user_id}, year {tax_year}"
        )
    ...
    def export_to_hr_block(
        ...
        logger.info(
            f"Exported tax data to H&R Block for user {user_id}, year {tax_year}"
        )
    ...
    def export_generic(
        ...
        logger.info(
            f"Exported tax data in {format} format for user {user_id}, year {tax_year}"
        )
    ...
    def get_export(self, export_id: str) -> TaxSoftwareExport | None:
        """Get export by ID"""
    ...
    def list_user_exports(
        ...
        exports = [exp for exp in self.exports.values() if exp.user_id == user_id]
