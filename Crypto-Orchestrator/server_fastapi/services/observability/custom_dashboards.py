...
class CustomDashboardsService:
    ...
    def get_dashboard(self, dashboard_id: str, user_id: Optional[int] = None) -> Optional[Dashboard]:
        """Get dashboard by ID"""
    ...
    def list_user_dashboards(self, user_id: int) -> List[Dashboard]:
        ...
        return [
            self.dashboards[did] for did in dashboard_ids
            if did in self.dashboards
        ]
