...
class DistributedCacheConsistencyService:
    ...
    def invalidate_key(
        ...
        logger.debug(f"Invalidated cache key {cache_key} (version {self.cache_versions[cache_key].version})")
    ...
    def invalidate_pattern(
        ...
        # Find matching keys
        matching_keys = [
            key for key in self.cache_versions.keys()
    ...
    def get_version(self, cache_key: str) -> Optional[int]:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        recent_events = [
            e for e in self.invalidation_events
