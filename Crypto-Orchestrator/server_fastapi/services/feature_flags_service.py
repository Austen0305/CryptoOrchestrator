...
class FeatureFlagsService:
    ...
    async def _check_rollout(self, flag: FeatureFlag, user_id: Optional[int]) -> bool:
    ...
    async def get_flag_stats(
        ...
        eval_stmt = select(
            ...
            func.count(case((FlagEvaluation.enabled == True, 1))).label("enabled_count"),
        ).where(
            and_(
    ...
    async def get_experiment_results(
        ...
        stmt = select(
            ...
            func.count(case((ExperimentAssignment.converted == True, 1))).label("conversions"),
