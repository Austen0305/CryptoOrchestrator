...
try:
    ...
    DID_AVAILABLE = False
    logger.warning("DID library not available. Install with: pip install didkit or similar")
...
class DIDService:
    ...
    def create_presentation(
        ...
        # Get credentials
        credentials = [
            self.credentials[cid] for cid in credential_ids
        ...
        # Generate proof
        proof = self._generate_proof(holder_did, presentation_id, {
    ...
    def verify_presentation(self, presentation_id: str) -> bool:
        ...
        return self._verify_proof(
            ...
            presentation_id,
            {"credentials": [c.credential_id for c in presentation.verifiable_credentials]},
            presentation.proof,
        )
