...
try:
    ...
    logger.warning("TECDSA library not available. Install with: pip install tss-lib or similar")
...
class TECDSASignature:
    ...
    v: Optional[int] = None  # Recovery ID (for Ethereum)
...
class TECDSAService:
    ...
    def get_signature(self, signature_id: str) -> Optional[TECDSASignature]:
        """Get signature by ID"""
