...
#### `GET /api/institutional/treasury/summary`
...
#### `GET /api/institutional/treasury/balances`
Get treasury wallet balances.

#### `GET /api/institutional/treasury/activity`
Get treasury activity log.

#### `GET /api/institutional/treasury/risk-metrics`
Get treasury risk metrics.

### Observability

#### `GET /api/observability/traces`
Get distributed traces for observability.

**Query Parameters:**
- `service` (optional): Filter by service name
- `status` (optional): Filter by status ("ok" or "error")
- `time_range`: Time range ("15m", "1h", "6h", "24h", "7d")
