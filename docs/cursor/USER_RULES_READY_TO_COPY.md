# User Rules - Ready to Copy & Paste

These are optimized for direct copy-paste into Cursor Settings → User Rules.

---

## 📋 RULE 1: Communication & Core Quality

Copy everything below this line into Rule 1:
...
Copy everything below this line into Rule 2:
...
Copy everything below this line into Rule 3:
...
Copy everything below this line into Rule 4:
...
Copy everything below this line into Rule 5:
...
3. Click "Add Rule" for each of the 5 rules above
4. Copy the entire content for each rule (everything between the separator lines)
5. Paste into Cursor's rule editor
6. Save and restart Cursor

Each rule is self-contained and ready to copy-paste directly!
