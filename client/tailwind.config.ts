  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "glow-blue": "0 0 20px hsl(210 100% 50% / 0.3)",
        "glow-green": "0 0 20px hsl(142 76% 36% / 0.3)",
        "glow-red": "0 0 20px hsl(0 84% 40% / 0.3)",
      },
      backgroundImage: {
  ...
  plugins: [
    ...
    function ({ addUtilities }: { addUtilities: (utilities: Record<string, Record<string, string>>) => void }) {
      addUtilities({
        ...
        '.shadow-glow-blue': {
          'box-shadow': '0 0 15px hsl(210 100% 50% / 0.3)',
        },
        '.shadow-glow-green': {
        ...
        '.drop-shadow-glow-blue': {
          'filter': 'drop-shadow(0 0 8px hsl(210 100% 50% / 0.4))',
        },
      });
    },
  ],
