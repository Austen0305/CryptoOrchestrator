...
describe("QuickStats", () => {
  it("renders all stat cards", () => {
    render(<QuickStats totalValue={10000} change24h={5.2} activeBots={3} totalTrades={150} />);
  ...
  it("formats currency correctly", () => {
    render(<QuickStats totalValue={12345.67} change24h={0} activeBots={0} totalTrades={0} />);
  ...
  it("shows positive change in green", () => {
    const { container } = render(
      <QuickStats totalValue={10000} change24h={5.2} activeBots={0} totalTrades={0} />
    );
  ...
  it("shows negative change in red", () => {
    const { container } = render(
      <QuickStats totalValue={10000} change24h={-3.5} activeBots={0} totalTrades={0} />
    );
